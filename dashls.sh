...
#
ffmpeg -i $1 -c:a copy -c:v libx264 -x264opts 'keyint=25:min-keyint=25:no-scenecut' -b:v 5M -maxrate 5M -bufsize 2M out5.mp4
...
# no audio, bitrate 2M, resize to 960x540 (no correct resize for 480)
ffmpeg -i $1  -an -c:v libx264 -x264opts 'keyint=25:min-keyint=25:no-scenecut' -b:v 2M -maxrate 2M -bufsize 500k -vf "scale=-1:540" out3.mp4
...
bento4/bin/mp4dash --hls out5f.mp4 out4f.mp4 out3f.mp4 out2f.mp4 out1f.mp4 
# some cleanup
mv out5f.mp4 $1.ref.mp4
rm out?.mp4
rm out?f.mp4
